package com.eresearch.dblp.consumer.db.scheduler;
        ...
        transactionTemplate.execute(new TransactionCallbackWithoutResult() {
            ...
            protected void doInTransactionWithoutResult(TransactionStatus transactionStatus) {
                try {
                    ...
                    jdbcTemplate.update(dblpConsumerDao.getDeleteQueryForSearchResultsTable());
                    jdbcTemplate.update(dblpConsumerDao.getResetAutoIncrementForSearchResultsTable());
